...
*/
    ...
    */
    ...
    public function __construct(){
        $this->dolapikey = 'jVsEA99I1sFHEcm27Ib9ki1E1v4IpJc8';
        $this->lien = 'http://dolibarr/api/index.php';
    }
    ...
    function getItemStock($productName, $warehouseName)
    {
        ...
        if ($responseData !== null) {
            if (isset($responseData['stock_warehouses'])) {
                return $responseData['stock_warehouses'][$warehouseId]['real'];
            } else {
